...
def get_filters():
    ...
    """
    print('Hello! Let\'s explore some US bikeshare data by city!')
    print()
    ...
    while 1:
        choice = input('Do you want to filter the data by month and/or day of week? Yes/No ').lower()
        print()
    ...
    while 1:
        if choice:
            ...
            if filter=='month':
                ...
                print('Which day of week\'s data to look at? ')
